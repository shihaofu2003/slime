...
RUN_ROOT="${CHECKPOINT_ROOT}/Qwen3-4B-Instruct-2507_tau2_agent_sft_banking_expert_full_20260908"
...
export PROJECT_ROOT
export ITER_DIR="${ITER_DIR:-${RUN_ROOT}/${ITER_NAME}}"
export OUTPUT_DIR="${OUTPUT_DIR:-${RUN_ROOT}/final_hf}"
export ORIGIN_HF_DIR="${ORIGIN_HF_DIR:-${MODEL_ROOT}/Qwen3-4B-Instruct-2507}"
