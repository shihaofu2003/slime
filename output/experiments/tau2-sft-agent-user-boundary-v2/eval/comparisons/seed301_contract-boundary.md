...
|---|---|---:|---:|---:|
| contract-boundary-raw_instruct | pass@1 / pass^1 | -0.25 pp | [-6.00, +5.75] pp | no |
| contract-boundary-raw_instruct | pass@4(any) | -3.00 pp | [-13.00, +7.00] pp | no |
| contract-boundary-raw_instruct | pass^4 | +0.00 pp | [-7.00, +7.00] pp | no |
| contract-boundary-old_sft | pass@1 / pass^1 | +9.50 pp | [+3.50, +15.75] pp | yes |
| contract-boundary-old_sft | pass@4(any) | +17.00 pp | [+7.00, +28.00] pp | yes |
| contract-boundary-old_sft | pass^4 | +5.00 pp | [-1.00, +11.00] pp | no |
| contract-boundary-current_sft | pass@1 / pass^1 | -4.50 pp | [-9.75, +0.50] pp | no |
| contract-boundary-current_sft | pass@4(any) | -6.00 pp | [-15.00, +3.00] pp | no |
| contract-boundary-current_sft | pass^4 | +1.00 pp | [-5.00, +7.00] pp | no |
| contract-boundary-contract-only | pass@1 / pass^1 | -1.75 pp | [-7.00, +3.25] pp | no |
| contract-boundary-contract-only | pass@4(any) | +0.00 pp | [-9.00, +9.00] pp | no |
| contract-boundary-contract-only | pass^4 | +4.00 pp | [-1.00, +10.00] pp | no |
